        ...
        <div className="container relative mx-auto px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-xl text-muted-foreground md:text-2xl">
              Build, distribute, and analyze conjoint studies for subscription plans.
              Your data stays in your Google Sheet—no database, maximum control.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">
              Everything you need for conjoint research
            </h2>
            <p className="text-lg text-muted-foreground">
              Professional tools powered by Google Sheets
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <Card className="shadow-card transition-smooth hover:shadow-elegant p-8">
              ...
              <p className="text-muted-foreground">
                Your data never leaves your Google Sheet. Encrypted tokens ensure complete security.
              </p>
            </Card>
        ...
        <div className="container mx-auto px-6">
          <Card className="shadow-elegant gradient-primary p-12 text-center">
            ...
            <p className="mb-8 text-lg text-white/90">
              Create your first conjoint study in under 5 minutes
            </p>
            <Link to="/start">
